/**
 * @param {{ reader: import('./api').Reader<Uint8Array>, state: import('../api').BytesReaderState }} view
 * @param {number} length
 */
...
export class BytesReader {
  /**
   * @param {{ reader: import('./api').Reader<Uint8Array>, state: import('../api').BytesReaderState }} config
   */
